...
export default function NavBar() {
	...
	return (
		<>
			<nav
				className="sticky top-0 z-10 w-full border-b-2 border-black bg-cyan-300 px-8 py-8 text-gray-700 transition-all ease-in-out dark:border-0 dark:bg-gray-800 dark:text-white md:fixed"
